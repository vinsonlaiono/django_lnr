...
urlpatterns = [
    ...
    url(r'^remove/(?P<item_id>\d+)$', views.remove_item),    # This line has changed! Notice that urlpatterns is a list, the comma is in
    ...
    url(r'^additem/(?P<item_id>\d+)$', views.addmylist),    # This line has changed! Notice that urlpatterns is a list, the comma is in
